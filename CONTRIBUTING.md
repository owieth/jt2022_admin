...
Please note we have a [code of conduct](https://github.com/owieth/jt2022_admin/blob/master/CODE_OF_CONDUCT.md), please follow it in all your interactions with the project.
...
1.  [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone
    ...
    ```sh
    # Clone your fork
    git clone https://github.com/<your-username>/jt2022_admin.git
...
>
> ```sh
> git remote add upstream https://github.com/owieth/jt2022_admin.git
> git fetch upstream
